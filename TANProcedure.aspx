<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="TANProcedure.aspx.cs" Inherits="TANProcedure" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="container" style="font-family: Arial;font-size: 15px;line-height: 19px;width:100%">
        <h1>Online TAN Application Procedure</h1>
        <p>
...
<br><br>
        ...
        <p><span style="font-weight: bold;">Types of TAN Application</span><br>
...
<ul>
     <li>Form for Change or Correction in TAN data for TAN Allotted</li>
        ...
        <ul><li>The fees for processing TAN Application is <span style="font-weight: bold;">Rs. 80</span> (including NSDL charge of Rs. 62 and our service tax as applicable)</li></ul>
