<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="TANGuidlines.aspx.cs" Inherits="TANGuidlines" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="container" style="font-family: Arial;font-size: 15px;line-height: 19px;width: 100%">
        <h1>Online TAN Application</h1>
        <p>
