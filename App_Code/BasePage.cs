...
public class BasePage : System.Web.UI.Page
{
    ...
    {
        if (Global.LogInDone == false && !Request.Url.ToString().ToLower().Contains("localhost"))
        {
            Response.Redirect("/login?return=" + Request.Path);
            return;
        }
    ...
    public void WriteCookie(System.Web.UI.Page page, string formType, string fy, string quarter, string companyId, string challanId, string reportType)
    {
        page.Response.Cookies["ReturnFormFilter"]["FinancialYear"] = fy;
        page.Response.Cookies["ReturnFormFilter"]["FormType"] = formType;
        page.Response.Cookies["ReturnFormFilter"]["Quarter"] = quarter;
        page.Response.Cookies["ReturnFormFilter"]["CompanyID"] = companyId;
        page.Response.Cookies["ReturnFormFilter"]["ChalanID"] = challanId;
        page.Response.Cookies["ReturnFormFilter"]["ReporType"] = reportType;
        page.Response.Cookies["ReturnFormFilter"].Expires = DateTime.Now.AddDays(1);
    }
}